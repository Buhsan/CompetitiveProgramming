...
void solve(int tt){
  ...
  cout << sub("1.2", "0.3") << endl;
  // int i = 1;
  // double res = 0;
  // for (int i = 0; i < 100; i++) {
  //   res += pow(-1, i) * (1 / (double) (2 * i + 1));
  // }
  // cout << res << endl;
