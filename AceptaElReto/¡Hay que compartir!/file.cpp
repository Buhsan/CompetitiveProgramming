...
void solve(int tt){
  ...
  while(cin >> n && n) {
    ...
    REP(i,0,n){
      ...
      cin.ignore();
      int n2; cin >> n2;
      if (i == 0) denominador = n2, numerador = n1;
      else {
        int d = __lcm(denominador, n2);
        numerador = (d/denominador * numerador) + (d/n2 * n1);
        denominador = d;
      }
    }
    cout << (denominador-numerador >= 0 ? denominador-numerador : 0) << endl;
  }
}
