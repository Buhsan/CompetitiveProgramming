...
void solve(int tt){
    int n, x, y;
    cin >> n >> x >> y;
    // vint res = {0,0,0,0}; //sides, tops, right diagonal left diagonal
    set<pair<double,double>> vect;
    ...
    REP(i,0,n){
        ...
        // P(new_x);
        // P(new_y);
        // double modulo = sqrt((new_x*new_x) + (new_y*new_y));
        // double mode_x = new_x/modulo;
        // double mode_y = new_y/modulo;
